...
import rmi.server.SerializableRmiServerInterface;
 ...
 * 传递给客户端。
 */
public class SerializableRmiClient {
    @Test
    public void client() throws RemoteException, MalformedURLException, NotBoundException {
        SerializableRmiServerInterface obj = (SerializableRmiServerInterface) Naming.lookup("//localhost/RmiServer");
