...
.provider('docsSearch', function() {
  ...
  // This version of the paramtransfer.service builds the index in the current thread,
  ...
  function localSearchFactory($http, $timeout, NG_PAGES) {
    ...
    // The actual paramtransfer.service is a function that takes a query string and
  ...
  // This version of the paramtransfer.service builds the index in a WebWorker,
