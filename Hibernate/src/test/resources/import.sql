...
CREATE TABLE person_one2onefk(personid integer IDENTITY PRIMARY KEY,name varchar(255) DEFAULT NULL,age integer DEFAULT NULL ,addressid integer DEFAULT NULL);